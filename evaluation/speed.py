...
from NineMenMorris.players import QNetPlayer, RandomPlayer, VNetPlayer, VisualPlayer, MCTSPlayer  # , MiniMaxPlayer, AlphaZeroTestPlayer, AlphaZeroPlayer
...
print("player avrg move time = {} s over {} moves".format(player0.avrg_move_time(), player0.n_moves()))
