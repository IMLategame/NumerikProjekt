...
from TicTacToe.players import QNetPlayer, RandomPlayer
from network_backend.reinforcement_learning.utils import ReplayMem
from network_backend.reinforcement_learning.encodings import QEncoding, TTTQEncoding
...
memory = ReplayMem(10, 1, net, gamma=0.95, encode=TTTQEncoding(), goal_value_function=QGoal())
...
eval_mem = ReplayMem(2000, 1, net, gamma=0.99, encode=TTTQEncoding(), goal_value_function=QGoal())
